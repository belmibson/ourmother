...
THREE.OrbitControls=function(a,b){function d(){return 2*Math.PI/60/60*c.autoRotateSpeed}function g(a){!1!==c.enabled&&(a.preventDefault(),f===e.ROTATE?(p.set(a.clientX,a.clientY),q.subVectors(p,r),c.rotateLeft(2*Math.PI*q.x/u*c.userRotateSpeed),c.rotateUp(2*Math.PI*q.y/u*c.userRotateSpeed),r.copy(p)):f===e.ZOOM?(s.set(a.clientX,a.clientY),v.subVectors(s,t),0<v.y?c.zoomIn():c.zoomOut(),t.copy(s)):f===e.PAN&&c.pan(new THREE.Vector3(-(a.movementX||a.mozMovementX||a.webkitMovementX||0),a.movementY||a.mozMovementY||
a.webkitMovementY||0,0)))}function h(a){!1!==c.enabled&&!1!==c.userRotate&&(document.removeEventListener("mousemove",g,!1),document.removeEventListener("mouseup",h,!1),f=e.NONE)}function n(a){if(!1!==c.enabled&&!1!==c.userZoom){var b=0;a.wheelDelta?b=a.wheelDelta:a.detail&&(b=-a.detail);0<b?c.zoomOut():c.zoomIn()}}this.object=a;this.domElement=void 0!==b?b:document;this.enabled=!0;this.center=new THREE.Vector3;this.userZoom=!0;this.userZoomSpeed=1;this.userRotate=!0;this.userRotateSpeed=1;this.userPan=
!0;this.userPanSpeed=2;this.autoRotate=!1;this.autoRotateSpeed=2;this.minPolarAngle=0;this.maxPolarAngle=Math.PI;this.minDistance=0;this.maxDistance=Infinity;this.keys={LEFT:37,UP:38,RIGHT:39,BOTTOM:40,ROTATE:65,ZOOM:83,PAN:68};var c=this,u=1800,r=new THREE.Vector2,p=new THREE.Vector2,q=new THREE.Vector2,t=new THREE.Vector2,s=new THREE.Vector2,v=new THREE.Vector2,k=0,l=0,m=1,w=new THREE.Vector3,e={NONE:-1,ROTATE:0,ZOOM:1,PAN:2},f=e.NONE,x={type:"change"};this.rotateLeft=function(a){void 0===a&&(a=
d());l-=a};this.rotateRight=function(a){void 0===a&&(a=d());l+=a};this.rotateUp=function(a){void 0===a&&(a=d());k-=a};this.rotateDown=function(a){void 0===a&&(a=d());k+=a};this.zoomIn=function(a){void 0===a&&(a=Math.pow(0.95,c.userZoomSpeed));m/=a};this.zoomOut=function(a){void 0===a&&(a=Math.pow(0.95,c.userZoomSpeed));m*=a};this.pan=function(a){a.transformDirection(this.object.matrix);a.multiplyScalar(c.userPanSpeed);this.object.position.add(a);this.center.add(a)};this.update=function(){var a=this.object.position,
b=a.clone().sub(this.center),c=Math.atan2(b.x,b.z),e=Math.atan2(Math.sqrt(b.x*b.x+b.z*b.z),b.y);this.autoRotate&&this.rotateLeft(d());var c=c+l,e=e+k,e=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,e)),e=Math.max(1E-6,Math.min(Math.PI-1E-6,e)),f=b.length()*m,f=Math.max(this.minDistance,Math.min(this.maxDistance,f));b.x=f*Math.sin(e)*Math.sin(c);b.y=f*Math.cos(e);b.z=f*Math.sin(e)*Math.cos(c);a.copy(this.center).add(b);this.object.lookAt(this.center);k=l=0;m=1;0<w.distanceTo(this.object.position)&&
(this.dispatchEvent(x),w.copy(this.object.position))};this.domElement.addEventListener("contextmenu",function(a){a.preventDefault()},!1);this.domElement.addEventListener("mousedown",function(a){!1!==c.enabled&&!1!==c.userRotate&&(a.preventDefault(),f===e.NONE&&(0===a.button&&(f=e.ROTATE),1===a.button&&(f=e.ZOOM),2===a.button&&(f=e.PAN)),f===e.ROTATE?r.set(a.clientX,a.clientY):f===e.ZOOM&&t.set(a.clientX,a.clientY),document.addEventListener("mousemove",g,!1),document.addEventListener("mouseup",h,!1))},
!1);this.domElement.addEventListener("mousewheel",n,!1);this.domElement.addEventListener("DOMMouseScroll",n,!1);window.addEventListener("keydown",function(a){if(!1!==c.enabled&&!1!==c.userPan)switch(a.keyCode){case c.keys.ROTATE:f=e.ROTATE;break;case c.keys.ZOOM:f=e.ZOOM;break;case c.keys.PAN:f=e.PAN}},!1);window.addEventListener("keyup",function(a){switch(a.keyCode){case c.keys.ROTATE:case c.keys.ZOOM:case c.keys.PAN:f=e.NONE}},!1)};THREE.OrbitControls.prototype=Object.create(THREE.EventDispatcher.prototype);
...
THREEx.FullScreen.bindKey=function(a){a=a||{};var b=a.charCode||102,d=void 0!==a.dblclick?a.dblclick:!1,g=a.element,h=function(){THREEx.FullScreen.activated()?THREEx.FullScreen.cancel():THREEx.FullScreen.request(g)},n=function(a){a.which===b&&h()}.bind(this);document.addEventListener("keypress",n,!1);d&&document.addEventListener("dblclick",h,!1);return{unbind:function(){document.removeEventListener("keypress",n,!1);d&&document.removeEventListener("dblclick",h,!1)}}};THREEx=THREEx||{};
